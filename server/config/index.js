...
// AI provider: "claude", "gemini", "codex", or "pi" (pi = Pi agent, preferred)
export const DEFAULT_PROVIDER = process.env.DEFAULT_PROVIDER || "pi";
 ...
 * @param {string} provider - provider name (e.g. "pi", "claude", "gemini", "codex")
